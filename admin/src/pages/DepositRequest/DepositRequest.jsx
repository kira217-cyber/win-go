...
const DepositRequest = () => {
  ...
  // Local filters for immediate UI response
  const [localFilters, setLocalFilters] = useState({
    status: "all",
    search: "",
  });

  // Actual filters used in query (updated only after debounce)
  ...
  // Debounce: Update queryFilters.search only after user stops typing
  useEffect(() => {
  ...
  // Sync status changes immediately
  useEffect(() => {
    setQueryFilters((prev) => ({
      ...prev,
  ...
  // Fetch deposit requests using queryFilters
  const { data, isLoading, isError, isFetching } = useQuery({
    queryKey: ["deposit-requests", queryFilters],
    queryFn: () =>
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-[60vh] text-orange-300">
        ...
        <span className="ml-4 text-xl">Loading deposit requests...</span>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          <div className="relative flex-1">
            ...
            />
            {/* Show subtle loading indicator only during search fetch */}
          ...
          <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-gradient-to-b from-orange-950 to-red-950 border border-red-800/50 rounded-2xl p-8 max-w-md w-full shadow-2xl shadow-red-950/60">
              ...
              <p className="text-orange-200/90 mb-6">
                ...
                <br />
                Amount + bonus will be added to user's balance.
              </p>
              <textarea
